...
The animation file "Predictions and Probabilities for Each Epoch.mp4" shows the training progress from epoch 1 through epoch 25. <br>Below is the animated gif version. Download the mp4 version to view the animation with a slider control in your favorite movie viewer.
